...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field selected_subjects on 'UserProfile'
        m2m_table_name = db.shorten_name('user_profile_selected_subjects')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'front.userprofile'], null=False)),
            ('subject', models.ForeignKey(orm[u'ajax.subject'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'subject_id'])


    def backwards(self, orm):
        # Removing M2M table for field selected_subjects on 'UserProfile'
        db.delete_table(db.shorten_name('user_profile_selected_subjects'))
    ...
    models = {
        ...
        u'front.userprofile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'selected_subjects': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'profiles'", 'symmetrical': 'False', 'to': u"orm['ajax.Subject']"}),
